...
export const case1Evidence: Record<string, Evidence> = {
  maya_profile: {
    ...
    photo: mayaImage,
    description: "Maya leads the game balance team and has full admin access (admin01 account). She's known for being meticulous and detail-oriented, but recent workload has been affecting her.",
    personality: "Perfectionist, hardworking, detail-oriented. Often works late nights to ensure everything is perfect. Recently stressed due to increased pressure.",
    suspicionLevel: 2,
    timestamp: Date.now(),
  ...
  chris_profile: {
    ...
    photo: chrisImage,
    description: "Chris analyzes game statistics and player behavior patterns. He's working on a secretive AI matchmaking research project on the side.",
    personality: "Analytical, ambitious, secretive. Passionate about AI and data science. Sometimes prioritizes personal projects over team responsibilities.",
    suspicionLevel: 4,
    timestamp: Date.now(),
    unlockedByNode: "meet_team",
  },
  ...
  ryan_profile: {
    ...
    photo: ryanImage,
    description: "Ryan manages server infrastructure and database logs. He's frustrated with company culture and believes in transparency and accountability.",
    personality: "Principled, honest, idealistic. Frustrated with workplace issues. Believes data and logs don't lie. Not afraid to speak up.",
    suspicionLevel: 3,
    timestamp: Date.now(),
    unlockedByNode: "meet_team",
  },
